...
const EditSalesStrategyPage = async ({
  params,
}: {
  ...
  // The delete dialog says what it would cost, which means knowing how many
  // leads are on it.
  ...
  return (
    <SalesStrategyForm
      ...
      strategy={strategy}
      leadCount={getPerformance(performance, strategy.id).leads}
    />
  );
};

export default EditSalesStrategyPage;
